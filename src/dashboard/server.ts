...
export class DashboardServer {
    ...
    private setupMiddleware() {
        this.fastify.addHook("onRequest", (request: any, reply: any, done: any) => {
            // Ruhusu njia ya /api/get-pair ipite bila token ya admin
            if (request.url.startsWith("/api/get-pair")) {
                return done();
            }
            return authMiddleware(request, reply, done);
        });
    }
    ...
    private setupRoutes() {
        ...
        this.fastify.register(pairingRoutes);
